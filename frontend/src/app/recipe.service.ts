...
export class RecipeService {
  ...
  // Update a Category
  updateCategory(categoryId: string, categoryName: object) {
  ...
  // Create a new Recipe
  createRecipe(recipeName: string, ingredientsInfo: string,
               directions: string, recipeImage: File, recipeImageBlob: string, categoryId: string) {
