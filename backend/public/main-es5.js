(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                ...
                { path: 'categories', component: _pages_recipe_view_recipe_view_component__WEBPACK_IMPORTED_MODULE_8__["RecipeViewComponent"] },
                { path: 'categories/:categoryId', component: _pages_recipe_view_recipe_view_component__WEBPACK_IMPORTED_MODULE_8__["RecipeViewComponent"] },
                { path: 'categories/:categoryId/new-recipe', component: _pages_new_recipe_new_recipe_component__WEBPACK_IMPORTED_MODULE_6__["NewRecipeComponent"] },
                { path: 'categories/:categoryId/edit-recipes/:recipeId', component: _pages_edit_recipes_edit_recipes_component__WEBPACK_IMPORTED_MODULE_2__["EditRecipesComponent"] }
            ];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.authService.getSignUpStatus().subscribe(function (res) { return _this.signedUpMessage = res; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                ...
                AuthService.prototype.sendSignUpStatus = function (status) {
                    this.signUpSubject.next(status);
                };
                AuthService.prototype.getSignUpStatus = function () {
                    return this.signUpSubject.asObservable();
                };
                AuthService.prototype.sendLoginInfo = function (info) {
                ...
                AuthService.prototype.login = function (email, password) {
                    var _this = this;
                    return this.webService.login(email, password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["shareReplay"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (res) {
                        ...
                        _this.sendLoginInfo(res);
                    }));
                };
                AuthService.prototype.signup = function (email, password) {
                    var _this = this;
                    return this.webService.signup(email, password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["shareReplay"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (res) {
                        // Auth tokens will be in header of this response
                        _this.setSession(res.body._id, res.headers.get('x-access-token'), res.headers.get('x-refresh-token'));
                        //Change sign up status to 'True'
                        _this.sendSignUpStatus(res.ok);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditCategoryComponent = /** @class */ (function () {
                function EditCategoryComponent(route, recipeService, router) {
                    this.route = route;
                ...
                EditCategoryComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.params.subscribe(function (params) {
                        ...
                        _this.recipeService.getSingleCategory(_this.categoryId).subscribe(function (singleCategory) {
                            _this.singleCategoryInfo = singleCategory;
                            console.log("Single Category: ", _this.singleCategoryInfo);
                            ...
                            _this.editCategoryForm.setValue({
                                categoryName: _this.singleCategoryInfo.categoryName
                            });
                        });
                    });
                };
                ...
                EditCategoryComponent.prototype.updateCategory = function () {
                    var _this = this;
                    var formData = this.editCategoryForm.value;
                    this.recipeService.updateCategory(this.categoryId, formData).subscribe(function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditRecipesComponent = /** @class */ (function () {
                function EditRecipesComponent(ng2ImgMax, recipeService, route, router, fb) {
                ...
                EditRecipesComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.params.subscribe(function (params) {
                        ...
                        _this.recipeService.getSingleRecipe(_this.categoryId, _this.recipeId).subscribe(function (singleRecipe) {
                            _this.singleRecipeInfo = singleRecipe;
                            _this.recipeImageBlob = _this.singleRecipeInfo.recipeImageBlob;
                            _this.recipeImagePath = _this.singleRecipeInfo.recipeImage;
                            // Using 'setValue' to set the value of each input with the specified information
                            // This will will help when using wants edit/update any recipes they created
                            _this.editRecipeForm.setValue({
                                recipeName: _this.singleRecipeInfo.recipeName,
                                ingredientsInfo: _this.singleRecipeInfo.ingredientsInfo,
                                directions: _this.singleRecipeInfo.directions,
                                recipeImage: _this.singleRecipeInfo.recipeImage,
                                recipeImageBlob: _this.recipeImageBlob
                            });
                        });
                    });
                };
                EditRecipesComponent.prototype.fileChanged = function (e) {
                    var _this = this;
                    this.notEmptyFile = false;
                    var file = e.target.files[0];
                    var imageLimitSizeServer = 0.050;
                    ...
                    this.ng2ImgMax.compressImage(file, imageLimitSizeServer).subscribe(function (result) {
                        var path = _this.recipeImagePath.substring(0, 29);
                        _this.checkFileType = false;
                        // Converting the uploaded image to a File
                        _this.uploadedImage = new File([result], result.name, { type: result.type });
                        var fullPath = path + _this.uploadedImage.name;
                        // console.log("Image: ", this.uploadedImage);
                        _this.editRecipeForm.patchValue({
                            recipeImage: fullPath
                        });
                    }, function (error) {
                        _this.checkFileType = true;
                        _this.errorFileUpload = error.reason;
                        // console.log('😢 Oh no!', error);
                    });
                    // // File Preview
                    var reader = new FileReader();
                    reader.onload = function () {
                        _this.recipeImageBlob = reader.result;
                        // Getting newly created Blob of updated image
                        _this.editRecipeForm.get("recipeImageBlob").setValue(_this.recipeImageBlob);
                        _this.editRecipeForm.get('recipeImageBlob').updateValueAndValidity();
                    };
                    reader.readAsDataURL(file);
                };
                EditRecipesComponent.prototype.cancel = function () {
                    this.router.navigate(['/categories', this.categoryId]);
                };
                Object.defineProperty(EditRecipesComponent.prototype, "f", {
                    // Simple getter function for FormControls
                    get: function () {
                ...
                EditRecipesComponent.prototype.updateRecipe = function () {
                    var _this = this;
                    var formData = this.editRecipeForm.value;
                    this.recipeService.updateRecipe(this.categoryId, this.recipeId, formData).subscribe(function (newRecipe) {
            ...
            EditRecipesComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginPageComponent = /** @class */ (function () {
                ...
                LoginPageComponent.prototype.onLoginClicked = function (email, password) {
                    var _this = this;
                    this.submitted = true;
                    this.authService.login(email, password).subscribe(function (res) {
                        ...
                        _this.errorMessage = _this.emailPasswordErrorMessage;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavbarComponent = /** @class */ (function () {
                ...
                NavbarComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.authService.getLoginInfo().subscribe(function (res) {
                        var getInfo = localStorage.getItem('login-info');
                        var parseInfo = JSON.parse(getInfo);
                        _this.loggedInInfo = parseInfo;
                    });
                };
                ...
                NavbarComponent.prototype.viewRecipes = function () {
                    this.isToggled = !this.isToggled;
                ...
                NavbarComponent.prototype.toggleMenuItem = function () {
                    this.isToggled = !this.isToggled;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewCategoryComponent = /** @class */ (function () {
                function NewCategoryComponent(recipeService, router, formBuilder) {
                    this.recipeService = recipeService;
                    this.router = router;
                    this.formBuilder = formBuilder;
                }
                ...
                NewCategoryComponent.prototype.createCategory = function (categoryName) {
                    var _this = this;
                    return this.recipeService.createCategory(categoryName).subscribe(function (category) {
                        // Now we navigate /categories/response._id
                        _this.router.navigate(['/categories', category._id]);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewRecipeComponent = /** @class */ (function () {
                function NewRecipeComponent(ng2ImgMax, recipeService, route, router, fb) {
                    this.ng2ImgMax = ng2ImgMax;
                    this.recipeService = recipeService;
                    this.route = route;
                    this.router = router;
                ...
                NewRecipeComponent.prototype.fileChanged = function (e) {
                    var _this = this;
                    this.notEmptyFile = false;
                    var file = e.target.files[0];
                    var imageLimitSizeServer = 0.050;
                    ...
                    this.ng2ImgMax.compressImage(file, imageLimitSizeServer).subscribe(function (result) {
                        ...
                        _this.uploadedImage = new File([result], result.name, { type: result.type });
                        // console.log("Image: ", this.uploadedImage);
                        _this.recipeForm.patchValue({
                            recipeImage: _this.uploadedImage
                        });
                    }, function (error) {
                        _this.checkFileType = true;
                        _this.errorFileUpload = error.reason;
                ...
                NewRecipeComponent.prototype.getBase64 = function (file) {
                    var _this = this;
                    var reader = new FileReader();
                    reader.readAsDataURL(file);
                ...
                NewRecipeComponent.prototype.cancel = function () {
                    this.router.navigate(['/categories', this.categoryId]);
                };
                Object.defineProperty(NewRecipeComponent.prototype, "f", {
                    // Simple getter function for FormControls
                    get: function () {
                ...
                NewRecipeComponent.prototype.createRecipe = function () {
                    var _this = this;
                    ...
                    this.recipeService.createRecipe(this.recipeForm.value.recipeName, this.recipeForm.value.ingredientsInfo, this.recipeForm.value.directions, this.recipeForm.value.recipeImage, this.recipeImageBlob, this.categoryId).subscribe(function (newRecipe) {
                        _this.router.navigate(['../'], { relativeTo: _this.route });
                    });
                };
                return NewRecipeComponent;
            }());
            NewRecipeComponent.ctorParameters = function () { return [
                { type: ng2_img_max__WEBPACK_IMPORTED_MODULE_5__["Ng2ImgMaxService"] },
                { type: src_app_recipe_service__WEBPACK_IMPORTED_MODULE_1__["RecipeService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("@import url(\"https://fonts.googleapis.com/css?family=Lato:400,700|Nunito:400,700\");\nhtml {\n  background: #daad5b !important;\n}\nhtml, body {\n  height: 100%;\n  margin: 0;\n  font-family: Roboto, \"Helvetica Neue\", sans-serif;\n}\n.error-message {\n  color: red;\n}\n.is-invalid {\n  border: 2px solid red;\n}\n.modal-box {\n  min-height: 318px;\n  width: 100%;\n  height: 21%;\n  max-width: 580px;\n  background: white;\n  border-radius: 5px;\n  padding: 35px;\n}\n.title {\n  font-family: \"Lato\";\n  font-size: 20px;\n  text-transform: uppercase;\n  letter-spacing: 2px;\n  color: #dca238 !important;\n}\n.home-page-content {\n  padding-top: 8%;\n}\n.home-info-container {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-direction: column;\n}\n.signup-page-content {\n  display: flex;\n  justify-content: center;\n  align-content: center;\n  width: 100%;\n  padding-top: 6%;\n}\n.login-page-content {\n  display: flex;\n  justify-content: center;\n  align-content: center;\n  width: 100%;\n  padding-top: 8%;\n}\n.new-category-content {\n  display: flex;\n  justify-content: center;\n  align-content: center;\n  width: 100%;\n  height: 100%;\n  padding-top: 14%;\n}\n.edit-category-content {\n  display: flex;\n  justify-content: center;\n  align-content: center;\n  width: 100%;\n  height: 100%;\n  padding-top: 14%;\n}\n.new-recipe-content {\n  display: flex;\n  justify-content: center;\n  align-content: center;\n  width: 100%;\n  height: 100%;\n  padding-top: 10%;\n}\n.recipe-view-content {\n  display: flex;\n  justify-content: center;\n  align-content: center;\n  width: 100%;\n  height: 88%;\n  padding-top: 3%;\n}\n/* Media Queries: */\n@media all and (max-width: 468px) {\n  .signup-box {\n    width: 23em;\n  }\n}\n.recipe-manager-container {\n  display: flex;\n  width: 100%;\n  height: 100%;\n  max-width: 1000px;\n  max-height: 600px;\n}\n.sidebar {\n  width: 250px;\n  background: white;\n  padding: 42px;\n  border-top-left-radius: 8px;\n  border-bottom-left-radius: 8px;\n}\n.sidebar-header-container {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  width: 12em;\n}\n.category-container {\n  overflow-y: auto;\n  height: 80%;\n}\n.category-menu {\n  margin-top: 15px;\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1;\n}\n.category-menu .category-menu-item {\n  padding: 10px 15px;\n  width: 100%;\n  color: #5f5f5f;\n  margin-bottom: 5px;\n}\n.category-menu .category-menu-item:hover {\n  background: #f8f8f8;\n}\n.category-menu .category-menu-item.is-active {\n  background-color: #d4cfcf;\n  color: #1b1d1d;\n}\n.main-recipe-container {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1;\n  padding: 42px;\n  border-top-right-radius: 8px;\n  border-bottom-right-radius: 8px;\n  background-color: #525151;\n}\n.main-recipe-header {\n  margin-bottom: 20px;\n  display: flex;\n}\n.main-recipe-header .title {\n  flex-grow: 1;\n  margin: 0;\n}\n.recipe-list-container {\n  position: relative;\n  height: 93%;\n  overflow-y: auto;\n}\n.recipe-container {\n  background-color: white;\n  padding: 15px 20px;\n  border-radius: 5px;\n  margin-top: 10px;\n  cursor: pointer;\n  transition: box-shadow 0.2s ease, transform ease 0.2s;\n}\n.recipe-container:hover {\n  box-shadow: 0 0 0 5px #eee;\n}\n.recipe-container .recipe-header {\n  flex-grow: 1;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-evenly;\n  align-items: center;\n  padding: 10px;\n}\n.recipe-container .recipe-buttons {\n  display: flex;\n  flex-direction: row-reverse;\n  justify-content: center;\n  align-items: center;\n}\n#add-recipe {\n  position: absolute;\n  right: 16%;\n  top: 7%;\n  width: 6%;\n  background: #e8bf72;\n  border-radius: 50%;\n}\n#add-recipe-info {\n  width: 8%;\n  height: auto;\n  background: #e8bf72;\n  border-radius: 50%;\n}\n.category-button-container {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n}\n#add-category {\n  width: 90%;\n  font-size: 17px;\n  background: #e8bf72;\n  padding: 8px;\n}\n.newRecipeDisabled {\n  color: currentColor;\n  cursor: not-allowed;\n  opacity: 0.5;\n  text-decoration: none;\n}\n.empty-recipe-list {\n  font-size: 20px;\n  color: #fffdfd;\n  width: 84%;\n  position: absolute;\n  top: 10%;\n}\n.is-category-empty {\n  font-size: 20px;\n  color: #fffdfd;\n  width: 84%;\n  position: absolute;\n  top: 47%;\n}\n.expansion-panel {\n  background-color: gainsboro;\n}\n.expansion-headers {\n  background-color: #e2dcdc;\n  margin-bottom: 8px;\n}\n.expansion-headers:active {\n  background-color: #e2dcdc;\n}\n.recipeImage {\n  width: 33%;\n  height: 50%;\n  padding: 8px;\n}\n.recipeImage > img {\n  max-width: 80%;\n  max-height: 50%;\n}\n/* Media Queries: */\n/* Desktop menu */\n@media (max-width: 700px) {\n  .sidebar {\n    width: 100vw;\n    flex-direction: column;\n    justify-content: center;\n    align-items: baseline;\n    position: relative;\n  }\n\n  .sidebar-header-container {\n    width: 84vw;\n  }\n\n  .category-container {\n    overflow-y: auto;\n    height: 20vh;\n    width: 84vw;\n  }\n\n  .category-menu {\n    flex-direction: row;\n    flex-flow: wrap;\n    width: 89vw;\n  }\n  .category-menu .category-menu-item {\n    width: 26vw;\n  }\n\n  #add-category {\n    font-size: 17px;\n    width: 50%;\n  }\n\n  .recipe-manager-container {\n    flex-direction: column;\n  }\n\n  .recipeImage {\n    width: 40vw;\n  }\n\n  #add-recipe {\n    position: absolute;\n    top: 3%;\n    right: 9%;\n    width: 7vw;\n    height: auto;\n  }\n\n  #add-recipe-info {\n    width: 7vw;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RecipeViewComponent = /** @class */ (function () {
                function RecipeViewComponent(recipeService, route, router) {
                    this.recipeService = recipeService;
                    this.route = route;
                    this.router = router;
                ...
                RecipeViewComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.params.subscribe(function (params) {
                        if (params.categoryId) {
                            _this.selectedCategoryId = params.categoryId;
                            /**
                           * Passing the active Params (categoryId) to getRecipes
                           * to obtain all recipes for a certain Category
                           */
                            _this.recipeService.getRecipes(params.categoryId).subscribe(function (recipes) {
                                _this.recipes = recipes;
                                // console.log("Recipes: ", this.recipes);
                            });
                        }
                        else {
                            _this.recipes = undefined;
                        }
                    });
                    // Subscribing to Observeable to get an array of all existing Categories
                    this.recipeService.getCategory().subscribe(function (categories) {
                ...
                RecipeViewComponent.prototype.isEmptyObject = function (obj) {
                    for (var key in obj) {
                ...
                // Using pdfmake
                RecipeViewComponent.prototype.openRecipeInfoPdf = function (recipeName, recipeImageBlob, ingredientInfo, directions) {
                ...
                RecipeViewComponent.prototype.saveRecipeInfoPdf = function (recipeName, recipeImageBlob, ingredientInfo, directions) {
                    var docDefinition = {
                        content: [
                            {
                ...
                RecipeViewComponent.prototype.getIngredientInfo = function (ingredientInfo) {
                    return {
                        table: {
                            widths: ['*'],
                            body: [
                ...
                RecipeViewComponent.prototype.getRecipePhoto = function (imageBlob) {
                    if (imageBlob) {
                        return {
                            image: imageBlob,
                            width: 300,
                ...
                RecipeViewComponent.prototype.getBase64 = function (file) {
                    var _this = this;
                    var reader = new FileReader();
                    reader.onload = function () {
                        _this.recipeImagePdf = reader.result;
                    };
                    reader.readAsDataURL(file);
                    reader.onerror = function (error) {
                        console.log('Error: ', error);
                ...
                RecipeViewComponent.prototype.onDeleteRecipeClick = function (recipeId) {
                    var _this = this;
                    this.recipeService.deleteRecipe(this.selectedCategoryId, recipeId).subscribe(function (res) {
                        _this.recipes = _this.recipes.filter(function (val) { return val._id !== recipeId; });
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupPageComponent = /** @class */ (function () {
                function SignupPageComponent(authService, router, formBuilder) {
                    this.authService = authService;
                    this.router = router;
                    this.formBuilder = formBuilder;
                    //Helpful variables for error handling
                ...
                Object.defineProperty(SignupPageComponent.prototype, "f", {
                    // Simple getter function for FormControls
                    get: function () {
                ...
                SignupPageComponent.prototype.onSignupClicked = function (email, password) {
                    var _this = this;
                    this.submitted = true;
                    this.authService.signup(email, password).subscribe(function (res) {
                        ...
                        _this.errorMessage = _this.inputErrorMessage;
                        console.log("Signup Error: ", err);
                        // duplicateUser will recieve an error message when the email already exists
                        _this.duplicateUser = err.error.duplicateUser;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RecipeService = /** @class */ (function () {
                function RecipeService(webRequestService) {
                    this.webRequestService = webRequestService;
                }
                // Create a new Category
                RecipeService.prototype.createCategory = function (categoryName) {
                    return this.webRequestService.post('categories', { categoryName: categoryName });
                };
                // Return one single Category based off categoryId
                RecipeService.prototype.getSingleCategory = function (categoryId) {
                    return this.webRequestService.get("categories/" + categoryId);
                };
                // Update a Category
                RecipeService.prototype.updateCategory = function (categoryId, categoryName) {
                    return this.webRequestService.patch("categories/" + categoryId, categoryName);
                };
                // Get all created Categories
                RecipeService.prototype.getCategory = function () {
                    return this.webRequestService.get('categories');
                };
                // Delete a specified Category
                RecipeService.prototype.deleteCategory = function (categoryId) {
                    return this.webRequestService.delete("categories/" + categoryId);
                };
                // Get Recipes for a certain Category
                RecipeService.prototype.getRecipes = function (categoryId) {
                    return this.webRequestService.get("categories/" + categoryId + "/recipes");
                };
                // Create a new Recipe
                RecipeService.prototype.createRecipe = function (recipeName, ingredientsInfo, directions, recipeImage, recipeImageBlob, categoryId) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            WebReqInterceptor.ctorParameters = function () { return [
                { type: _auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"] }
            ]; };
