(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesEditCategoryEditCategoryComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesEditRecipesEditRecipesComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesNewCategoryNewCategoryComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesNewRecipeNewRecipeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesRecipeViewRecipeViewComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAlertifyServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pages_edit_recipes_edit_recipes_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./pages/edit-recipes/edit-recipes.component */
    "./src/app/pages/edit-recipes/edit-recipes.component.ts");
    /* harmony import */


    var _pages_edit_category_edit_category_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./pages/edit-category/edit-category.component */
    "./src/app/pages/edit-category/edit-category.component.ts");
    /* harmony import */


    var _pages_signup_page_signup_page_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var _pages_new_recipe_new_recipe_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./pages/new-recipe/new-recipe.component */
    "./src/app/pages/new-recipe/new-recipe.component.ts");
    /* harmony import */


    var _pages_new_category_new_category_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./pages/new-category/new-category.component */
    "./src/app/pages/new-category/new-category.component.ts");
    /* harmony import */


    var _pages_recipe_view_recipe_view_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./pages/recipe-view/recipe-view.component */
    ...
    {
      path: 'new-category',
      component: _pages_new_category_new_category_component__WEBPACK_IMPORTED_MODULE_7__["NewCategoryComponent"]
    }, {
      path: 'edit-category/:categoryId',
      component: _pages_edit_category_edit_category_component__WEBPACK_IMPORTED_MODULE_3__["EditCategoryComponent"]
    }, {
      path: 'login',
      component: _pages_login_page_login_page_component__WEBPACK_IMPORTED_MODULE_5__["LoginPageComponent"]
    }, {
      path: 'signup',
      component: _pages_signup_page_signup_page_component__WEBPACK_IMPORTED_MODULE_4__["SignupPageComponent"]
    }, {
      path: 'home',
      component: _pages_home_home_component__WEBPACK_IMPORTED_MODULE_1__["HomeComponent"]
    }, {
      path: 'new-recipe',
      component: _pages_new_recipe_new_recipe_component__WEBPACK_IMPORTED_MODULE_6__["NewRecipeComponent"]
    }, {
      path: 'app-recipe-view',
      component: _pages_recipe_view_recipe_view_component__WEBPACK_IMPORTED_MODULE_8__["RecipeViewComponent"]
    }, {
      path: 'app-recipe-view/:categoryId',
      component: _pages_recipe_view_recipe_view_component__WEBPACK_IMPORTED_MODULE_8__["RecipeViewComponent"]
    }, {
      path: 'app-recipe-view/:categoryId/new-recipe',
      component: _pages_new_recipe_new_recipe_component__WEBPACK_IMPORTED_MODULE_6__["NewRecipeComponent"]
    }, {
      path: 'app-recipe-view/categories/:categoryId/edit-recipes/:recipeId',
      component: _pages_edit_recipes_edit_recipes_component__WEBPACK_IMPORTED_MODULE_2__["EditRecipesComponent"]
    }];
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AppComponent = class AppComponent {
      ...
      ngOnInit() {// this.authService.getSignUpStatus().subscribe(res =>
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _alertify_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./alertify.service */
    "./src/app/alertify.service.ts");
    /* harmony import */
    ...
    var src_app_recipe_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var _pages_recipe_view_recipe_view_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./pages/recipe-view/recipe-view.component */
    "./src/app/pages/recipe-view/recipe-view.component.ts");
    /* harmony import */
    ...
    var _pages_new_category_new_category_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./pages/new-category/new-category.component */
    "./src/app/pages/new-category/new-category.component.ts");
    /* harmony import */


    var _pages_new_recipe_new_recipe_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./pages/new-recipe/new-recipe.component */
    "./src/app/pages/new-recipe/new-recipe.component.ts");
    /* harmony import */
    ...
    var _web_req_interceptor__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./web-req-interceptor */
    ...
    var _pages_edit_category_edit_category_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./pages/edit-category/edit-category.component */
    "./src/app/pages/edit-category/edit-category.component.ts");
    /* harmony import */


    var _pages_edit_recipes_edit_recipes_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./pages/edit-recipes/edit-recipes.component */
    "./src/app/pages/edit-recipes/edit-recipes.component.ts");
    /* harmony import */
    ...
    var _pages_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./pages/navbar/navbar.component */
    "./src/app/pages/navbar/navbar.component.ts");
    /* harmony import */


    var ng2_img_max__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ng2-img-max */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_7__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_9__["AppComponent"], _pages_recipe_view_recipe_view_component__WEBPACK_IMPORTED_MODULE_10__["RecipeViewComponent"], _pages_new_category_new_category_component__WEBPACK_IMPORTED_MODULE_12__["NewCategoryComponent"], _pages_new_recipe_new_recipe_component__WEBPACK_IMPORTED_MODULE_13__["NewRecipeComponent"], _pages_login_page_login_page_component__WEBPACK_IMPORTED_MODULE_14__["LoginPageComponent"], _pages_signup_page_signup_page_component__WEBPACK_IMPORTED_MODULE_16__["SignupPageComponent"], _pages_edit_category_edit_category_component__WEBPACK_IMPORTED_MODULE_17__["EditCategoryComponent"], _pages_edit_recipes_edit_recipes_component__WEBPACK_IMPORTED_MODULE_18__["EditRecipesComponent"], _pages_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_21__["NavbarComponent"], _pages_home_home_component__WEBPACK_IMPORTED_MODULE_23__["HomeComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_6__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["ReactiveFormsModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_19__["BrowserAnimationsModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_20__["MatExpansionModule"], ng2_img_max__WEBPACK_IMPORTED_MODULE_22__["Ng2ImgMaxModule"]],
      schemas: [_angular_core__WEBPACK_IMPORTED_MODULE_7__["CUSTOM_ELEMENTS_SCHEMA"]],
      providers: [_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"], src_app_recipe_service__WEBPACK_IMPORTED_MODULE_3__["RecipeService"], _web_request_service__WEBPACK_IMPORTED_MODULE_2__["WebRequestService"], _alertify_service__WEBPACK_IMPORTED_MODULE_1__["AlertifyService"], {
        provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"],
        useClass: _web_req_interceptor__WEBPACK_IMPORTED_MODULE_15__["WebReqInterceptor"],
        multi: true
      }],
  ...
  function srcAppAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AuthService = class AuthService {
      constructor(webService, router, http, alertify) {
        ...
        this.router = router;
        this.http = http;
        this.alertify = alertify; // Using BehaviorSubject to check SignUp status
      ...
      login(email, password) {
        return this.webService.login(email, password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["shareReplay"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(res => {
          ...
          this.alertify.success("Hi there, ".concat(res.body.email)); // console.log('Response: ', res);
      ...
      signup(email, password) {
        return this.webService.signup(email, password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["shareReplay"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(res => {
          // Auth tokens will be in header of this response
          this.setSession(res.body._id, res.headers.get('x-access-token'), res.headers.get('x-refresh-token')); // Change sign up status to 'True'
          // this.sendSignUpStatus(res.ok);

          this.alertify.success('You signed up Successfully!'); // console.log('Response: ', res);
          // Catch error
      ...
      logout() {
        this.removeSession(); // This will fire when we get 401 unauthorized error
  ...
  /***/
  function srcAppPagesEditCategoryEditCategoryComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesEditCategoryEditCategoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      ngOnInit() {
        this.route.params.subscribe(params => {
          ...
          this.recipeService.getSingleCategory(this.categoryId).subscribe(singleCategory => {
            ...
            console.log('Single Category: ', this.singleCategoryInfo); // Using 'setValue' to set the value of each input with the specified information
    ...
    EditCategoryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/edit-category/edit-category.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./edit-category.component.scss */
      "./src/app/pages/edit-category/edit-category.component.scss")).default]
  ...
  /***/
  function srcAppPagesEditRecipesEditRecipesComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesEditRecipesEditRecipesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditRecipesComponent", function () {
    ...
    var src_app_recipe_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/recipe.service */
    "./src/app/recipe.service.ts");
    /* harmony import */
    ...
    var ng2_img_max__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ng2-img-max */
    "./node_modules/ng2-img-max/dist/ng2-img-max.js");
    ...
    let EditRecipesComponent = class EditRecipesComponent {
      ...
      ngOnInit() {
        this.route.params.subscribe(params => {
          ...
          this.recipeService.getSingleRecipe(this.categoryId, this.recipeId).subscribe(singleRecipe => {
            ...
            this.recipeImagePath = this.singleRecipeInfo.recipeImage; // Using 'setValue' to set the value of each input with the specified information
      ...
      fileChanged(e) {
        ...
        const imageLimitSizeServer = 0.050; // Name of uploaded file

        this.imageFileName = file.name; // File Validation
        ...
        this.ng2ImgMax.compressImage(file, imageLimitSizeServer).subscribe(result => {
          ...
          this.checkFileType = false; // Converting the uploaded image to a File

          this.uploadedImage = new File([result], result.name, {
            type: result.type
          });
          const fullPath = path + this.uploadedImage.name; // console.log("Image: ", this.uploadedImage);
          ...
          this.errorFileUpload = error.reason; // console.log('😢 Oh no!', error);
        }); // // File Preview

        const reader = new FileReader();

        reader.onload = () => {
          this.recipeImageBlob = reader.result; // Getting newly created Blob of updated image
    ...
    EditRecipesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-edit-recipes',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./edit-recipes.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/edit-recipes/edit-recipes.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./edit-recipes.component.scss */
      "./src/app/pages/edit-recipes/edit-recipes.component.scss")).default]
  ...
  function srcAppPagesLoginPageLoginPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let LoginPageComponent = class LoginPageComponent {
      constructor(authService, router, formBuilder, alertify) {
        ...
        this.alertify = alertify; // Helpful variables for error handling

        this.emailPasswordErrorMessage = 'The username or password you specified are invalid. Please try again.'; // Boolean to check when the form was submitted
      ...
      onLoginClicked(email, password) {
        ...
        this.authService.login(email, password).subscribe(res => {
          ...
          this.errorMessage = this.emailPasswordErrorMessage; // console.log('Login Error: ', err);
    ...
    LoginPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
  ...
  /***/
  function srcAppPagesNavbarNavbarComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let NavbarComponent = class NavbarComponent {
      ...
      logout() {
        ...
        localStorage.removeItem('user-id');
        localStorage.removeItem('x-access-token');
        localStorage.removeItem('x-refresh-token'); // Value now becomes 'null'
    ...
    NavbarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      ...
      "./src/app/pages/navbar/navbar.component.scss")).default]
    })], NavbarComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesNewCategoryNewCategoryComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesNewCategoryNewCategoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    NewCategoryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      selector: 'app-new-category',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./new-category.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/new-category/new-category.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./new-category.component.scss */
      "./src/app/pages/new-category/new-category.component.scss")).default]
  ...
  /***/
  function srcAppPagesNewRecipeNewRecipeComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesNewRecipeNewRecipeComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    let NewRecipeComponent = class NewRecipeComponent {
      constructor(ng2ImgMax, recipeService, route, router, fb) {
        ...
        this.router = router;
        this.fb = fb;
        this.notEmptyFile = true; // Booleans for File Uploads

        this.checkFileType = false;
        this.checkFileSize = false; // recipeForm = new FormGroup({
      ...
      fileChanged(e) {
        this.notEmptyFile = false;
        const file = e.target.files[0];
        const imageLimitSizeServer = 0.050; // File Validation
        ...
        this.recipeForm.get('recipeImage').updateValueAndValidity(); // // File Preview

        const reader = new FileReader();

        reader.onload = () => {
          this.recipeImageBlob = reader.result; // console.log("Blob: ", this.recipeImageBlob);
        };
      ...
      getBase64(file) {
        ...
        reader.onload = () => {
          ...
          this.recipeImageBlob = reader.result; // console.log("Read file as text: ", reader.readAsText(file));
        };
      ...
      createRecipe() {
        this.recipeService.createRecipe(this.recipeForm.value.recipeName, this.recipeForm.value.ingredientsInfo, this.recipeForm.value.directions, this.recipeForm.value.recipeImage, this.recipeImageBlob, this.categoryId).subscribe(() => {
    ...
    NewRecipeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      selector: 'app-new-recipe',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./new-recipe.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/new-recipe/new-recipe.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./new-recipe.component.scss */
      "./src/app/pages/new-recipe/new-recipe.component.scss")).default]
    })], NewRecipeComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesRecipeViewRecipeViewComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesRecipeViewRecipeViewComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RecipeViewComponent", function () {
    ...
    let RecipeViewComponent = class RecipeViewComponent {
      constructor(recipeService, route, router, alertify) {
        ...
        this.route = route;
        this.router = router;
        this.alertify = alertify; // Boolean values for expansion panels

        this.panelOpenStateIngred = false;
        this.panelOpenStateDirect = false; // Boolean value for when Categories are empty
      ...
      ngOnInit() {
        this.route.params.subscribe(params => {
          if (params.categoryId) {
            this.selectedCategoryId = params.categoryId; // Passing the active Params (categoryId) to getRecipes
            ...
            this.recipeService.getRecipes(params.categoryId).subscribe(recipes => {
              ...
              this.recipes = recipes.slice().reverse(); // console.log('Recipes: ', this.recipes);
            });
          } else {
        ...
        this.recipeService.getCategory().subscribe(categories => {
          this.categories = categories; // console.log('Categories: ', this.categories);
      ...
      openRecipeInfoPdf(recipeName, recipeImageBlob, ingredientInfo, directions) {
        ...
        const docDefinition = {
          info: {
            title: "".concat(recipeName, "-recipe")
          },
          content: [{
            text: "Recipe for ".concat(recipeName),
            bold: true,
            fontSize: 20,
            alignment: 'center',
            margin: [0, 0, 0, 20]
          }, {
            columns: [[this.getRecipePhoto(recipeImageBlob)]]
          }, {
            text: 'Ingredients',
            style: 'header'
          }, {
      ...
      saveRecipeInfoPdf(recipeName, recipeImageBlob, ingredientInfo, directions) {
        ...
        pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_5___default.a.createPdf(docDefinition).download("".concat(recipeName, "-recipe.pdf"));
      ...
      onDeleteCategoryClick(selectedCategoryId) {
        ...
        this.alertify.confirm("Are you sure you want to delete '".concat(getCategoryName[0].categoryName, "' Category?"), () => {
      ...
      onDeleteRecipeClick(recipeId) {
        ...
        this.alertify.confirm("Are you sure you want to delete '".concat(getRecipeName[0].recipeName, "' Recipe?"), () => {
          this.recipeService.deleteRecipe(this.selectedCategoryId, recipeId).subscribe(() => {
    ...
    RecipeViewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      selector: 'app-recipe-view',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./recipe-view.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/recipe-view/recipe-view.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./recipe-view.component.scss */
      "./src/app/pages/recipe-view/recipe-view.component.scss")).default]
    })], RecipeViewComponent);
    /***/
  },
  ...
  function srcAppPagesSignupPageSignupPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let SignupPageComponent = class SignupPageComponent {
      constructor(authService, router, formBuilder) {
        this.authService = authService;
        this.router = router;
        this.formBuilder = formBuilder; // Helpful variables for error handling

        this.inputErrorMessage = 'Invalid Email or Password.'; // Boolean to check when the form was submitted
      ...
      onSignupClicked(email, password) {
        ...
        this.authService.signup(email, password).subscribe(res => {
          ...
          this.errorMessage = this.inputErrorMessage; // console.log('Signup Error: ', err);
    ...
    SignupPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
  ...
  function srcAppRecipeServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let RecipeService = class RecipeService {
      ...
      createCategory(categoryName) {
        return this.webRequestService.post('categories', {
          categoryName
        });
      ...
      updateCategory(categoryId, categoryName) {
        return this.webRequestService.patch("categories/".concat(categoryId), categoryName);
      ...
      deleteCategory(categoryId) {
        return this.webRequestService.delete("categories/".concat(categoryId));
      ...
      createRecipe(recipeName, ingredientsInfo, directions, recipeImage, recipeImageBlob, categoryId) {
        ...
        return this.webRequestService.post("categories/".concat(categoryId, "/recipes"), formData);
      } // Delete a Recipe


      deleteRecipe(categoryId, recipeId) {
        return this.webRequestService.delete("categories/".concat(categoryId, "/recipes/").concat(recipeId));
      } // Update specified Recipe


      updateRecipe(categoryId, recipeId, formData) {
        return this.webRequestService.patch("categories/".concat(categoryId, "/recipes/").concat(recipeId), formData);
      } // Get one Recipe based on recipeId


      getSingleRecipe(categoryId, recipeId) {
        return this.webRequestService.get("categories/".concat(categoryId, "/recipes/").concat(recipeId));
      }
    ...
    RecipeService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
      providedIn: 'root'
    })], RecipeService);
    /***/
  },
  ...
  function srcAppWebReqInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    ...
    WebReqInterceptor = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
      providedIn: 'root'
    })], WebReqInterceptor);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/aaronromero/Desktop/Angular_Projects/Recipe_Collector/frontend/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
